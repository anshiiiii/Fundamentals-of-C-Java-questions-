...
int main() {
    int boatWeight, numAdults, numChildren;
    int weightAdults, weightChildren, totalWeight;

    printf("Enter the weight that the boat can handle: ");
    scanf("%d", &boatWeight);
    ...
    weightAdults = numAdults * 75;  
    weightChildren = numChildren * 30;  
    totalWeight = weightAdults + weightChildren;

   
    if(totalWeight <= boatWeight) {
